            ...
            <div class="w-full lg:ps-64">
                <div class="mx-auto max-w-7xl px-8">
                    <div class="mx-auto max-w-2xl py-16 lg:max-w-none ">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-200">Documentation</h2>
                        <p className=" text-gray-900 dark:text-gray-400 tracking-wide sm:text-lg text-xl mb-16 sm:max-w-6xl sm:mx-auto ">
                            This is the documentaion.
                        </p>
                        <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0 ">
                            {topics.topics.map((topic) => (
                                <div class="group relative ">
                                    <div class="w-full rounded-t-lg bg-gradient-to-br from-200 to-400 dark:bg-gradient-to-br dark:from-400 dark:to-600 object-cover aspect-video" >
                                    </div>
                                    <div class="pb-11 mb-6 w-full rounded-b-lg object-cover text-base font-semibold bg-gray-100 dark:bg-gray-800 aspect-video">
                                        <h3 class="text-lg pt-6 pl-6 pb-2 text-gray-700 dark:text-gray-200 capitalize">
                                            {topic}
                                        </h3>
                                        {docs.map((doc) => (
                                            <p class="pl-6">
